...
namespace HumaneSociety
{
    public static class UserInterface
    {
        ...
        public static void DisplayAnimalInfo(Animal animal)
        {
            ...
            List<string> info = new List<string>() {"ID: " + animal.AnimalId, animal.Name, animal.Age + "years old", "Demeanor: " + animal.Demeanor, "Kid friendly: " + BoolToYesNo(animal.KidFriendly), "pet friendly: " + BoolToYesNo(animal.PetFriendly), $"Location: " + animalRoom.RoomId, "Weight: " + animal.Weight.ToString(),  "Food amount in cups:" + animal.DietPlan.FoodAmountInCups};
            DisplayUserOptions(info);
            Console.ReadLine();
        ...
        {
            Console.Clear();
            List<string> info = new List<string>() { "Employee Information:", employee.FirstName, employee.LastName, employee.EmployeeNumber.ToString(), employee.Email };
            DisplayUserOptions(info);
            Console.ReadLine();
        }
