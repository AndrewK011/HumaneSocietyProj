...
namespace HumaneSociety
{
    ...
    {        
        ...
        {
            //Adoption adoption = db.Adoptions.Where(e => e.AnimalId == animalId && e.ClientId == clientId).FirstOrDefault();
            Adoption adoption = db.Adoptions.Single(e => e.AnimalId == animalId && e.ClientId == clientId);
            try
            {
